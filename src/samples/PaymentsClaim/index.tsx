...
// import PegaSession from '../PaymentsClaim/PegaSession';
...
//   const [Conn, setPConn] = useState<any>(null);
...
//   function createCase() {
//     displayPega();
//     PCore.getMashupApi().createCase('HMRC-Debt-Work-AffordAssess', PCore.getConstants().APP.APP);
//   }
...
//     }
//     PCore.getDataPageUtils()
//       .getPageDataAsync('D_MDTPWebAPI_Get', 'root', { AuthService: authService })
//       .then(() => {
...
export default function PaymentsClaim() {
  return (
    <>
      <h1>Hello Payments..!</h1>
      <PegaSession />
